<script lang="ts">
    let visionText = "Dünya çapında mükemmel tekstil ütüleme deneyimi sunan, teknolojik gelişmeleri takip eden ve müşteri memnuniyetini en üst seviyede tutan bir marka haline gelmek."
    let missionText = "Müşterilerimize en yüksek kalitede ve en inovasyonel ürünler sunmak, müşteri beklentilerini ve ihtiyaçlarını anlamaya odaklanmak, sürekli olarak teknolojik gelişmeleri takip etmek ve ütüleme işlemlerini kolaylaştırmak. Ayrıca, çevre dostu ürünler sunmak ve sürdürülebilir bir gelecek için sürekli olarak çalışmak. Müşteri memnuniyeti, mükemmel hizmet kalitesi ve çevre dostu ürünler ile pazar liderliğini korumak."
