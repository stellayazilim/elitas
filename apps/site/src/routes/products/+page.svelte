                ...
                <div class="row pb-3">
                    ...
                    <!-- Kazan Start-->
                        ...
                        <div class="col-12 mb-3 ">
                            <h3 class="font-weight-semi-bold ml-5">BUHAR KAZANLARI</h3>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-secondary mr-1"></i>Detayları Gör</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-info mr-1"></i>Detayları Gör</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <!-- Paskara Start-->
                        <div class="col-12 mb-3 ">
                            <h3 class="font-weight-semi-bold ml-5">PASKARALAR</h3>
                        </div>
